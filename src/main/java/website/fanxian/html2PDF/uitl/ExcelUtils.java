package website.fanxian.html2PDF.uitl;
...
public abstract class ExcelUtils {
     ...
     */
    public static <T> List<List<T>> importWorkBook(InputStream excelInputStream, List<String> ObjectPropNameList, Map<String,ImportExcelValidateTypeE> validFieldMap, Class<T> clazz) throws RuntimeException {
        ...
        if(validFieldMap != null) {
            ...
            if (workbookErrors != null && !workbookErrors.isEmpty()) {
                for (Message message : workbookErrors) {
                    logger.error("导入发生错误!" + "sheet:" + message.getSheetIndex() + "|col:" + message.getColumnIndex() + "|row:" + message.getRowIndex() + "|ErrorMsg:" + message.getMessage());
                }
